                                ...
                                <div class="containrow">
                                    <div class="row col-md-12 mt-3 mb-3">
                                        <div class="col-md-3">
                                            ...
                                            <select id="project0" name="project[]" class="form-select" required>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="multiple_portal0" name="multiple_portal[]" data-placeholder="Choose anything" class="multiple-select" required>                                                
                                            </select>                                    
                                        </div>
                                        <div class="col-md-3">
                                            <label for="inputname" class="form-label">Roles</label>
                                            <select id="multiple_role0" name="multiple_role[]" data-placeholder="Choose anything" class="multiple-select">
                                            </select>                                    
                                        </div>
...
@section('scripts')
    ...
    @endif
    <script>
         $("#project0").on('change', function(){
            getPortal(0);
        });
        $("#multiple_portal0").on('change', function(){
                        getRole(0);
                    });
         $(document).ready(function() {
            ...
            $.ajax({
                ...
                success : function(result){
                    ...
                    results.forEach(function(item) {
                        ...
                        $('#multiple_role'+pr).append($('<option>', {
                            value: item._id,
                            text: item.name
                        }));                      
